export default function Navbar() {
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-8 md:px-16 h-[64px] border-b border-white/[0.05] bg-[#050505]/80 backdrop-blur-md">
